...
```sh
npx degit noam-honig/study-app.git my-project
cd my-project
npm i
```
...
# Tutorial:
See [Creating a Fullstack Angular Remult app for non web developer](https://github.com/noam-honig/study-app/wiki/Creating-a-Fullstack-Angular-Remult-app-for-non-web-developer)
